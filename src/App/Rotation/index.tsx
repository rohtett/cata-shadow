...
const Rotation = () => {
  return (
    ...
    <section id="rotation">
      ...
      <ol>
        <li>Cast <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="mind-blast" /></div>Mind Blast</li>
        <li>Apply <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="shadow-word-pain" /></div>Shadow Word: Pain if the target will live to sustain at least half the duration.</li>
        <li>Cast <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="shadow-word-death" /></div>Shadow Word: Death if the boss is below 25% health</li>
        <li>Cast <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="mind-spike" /></div>Mind Spike if the target will not live for longer than 8 seconds.</li>
        <li>Apply and maintain <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="vampiric-touch" /></div>Vampiric Touch if the target will survive at least half the duration.</li>
        <li>Apply and maintain <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="devouring-plague" /></div>Devouring Plague if the target will survive at least half the duration.</li>
        <li>Use <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="mind-flay" /></div>Mind Flay to refresh <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="shadow-word-pain" /></div>Shadow Word: Pain if it is about to expire.</li>
        <li>Cast <div className="spell-border inline-border"><div className="spell-icon inline-icon" id="mind-flay" /></div>Mind Flay.</li>
      </ol>
      ...
      <h4><div className="spell-border"><div className="spell-icon" id="shadowfiend" /></div>Shadowfiend</h4>
      ...
      <h4><div className="spell-border"><div className="spell-icon" id="archangel" /></div>Archangel</h4>
      ...
      <h3>Macros</h3>
      <h4><div className="spell-border"><div className="spell-icon" id="shadowfiend" /></div>Shadowfiend Macro</h4>
      ...
      <h4><div className="spell-border"><div className="spell-icon" id="dispersion" /></div>Dispersion Macro</h4>
